...
import { readProjectConfigs, writeProjectConfig, writeSharedConfig, } from './implementations/readProjectConfigs.js';
const { replaceInFile } = pkg;
const { project, projectConfig, sharedConfig, team } = await readProjectConfigs();
